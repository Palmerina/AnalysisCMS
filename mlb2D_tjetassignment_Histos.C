...
TH2D *h_mlb_notb[2];//tjetassignment = 0 
TH2D *h_mlb_b[2]; //tjetassignment =1 
TH2D *h_mlb_match[2]; //tjetassignment = 2

TH2D *h_mlbcomb_notb[2];//tjetassignment = 0 
TH2D *h_mlbcomb_b[2]; //tjetassignment = 2
TH2D *h_mlbcomb_match[2]; //tjetassignment = 1
...
void mlb2D_tjetassignment_Histos() {
	...
	TFile *OutFile = new TFile("mlb2D_tjetassignmentHistos.root", "recreate");

	for (int hf = 0; hf<2; hf++) { // stop or top

		h_mlb_notb[hf]->Write();
		h_mlb_b[hf]->Write();
		h_mlb_match[hf]->Write();


		h_mlbcomb_notb[hf]->Write();
		h_mlbcomb_b[hf]->Write();
		h_mlbcomb_match[hf]->Write();
