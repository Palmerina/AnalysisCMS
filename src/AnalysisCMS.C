		...
		float   luminosity)
{
	...
	root_output = new TFile("rootfiles/" + _systematic + "/" + _analysis + "/" + _sample + "_palme.root", "recreate");

	if (_eventdump) txt_eventdump.open("txt/" + _systematic + "/" + _analysis + "/" + _sample + "_eventdump_palme.txt");
...
void AnalysisCMS::OpenMinitree()
{
	...
	root_minitree = new TFile("minitrees/" + _systematic + "/" + _analysis + "/" + _sample + "_palme.root", "recreate");
	...
	minitree->Branch("metPfType1",     &pfType1Met,      "metPfType1/F");
	minitree->Branch("metPfType1Phi",  &pfType1Metphi,   "metPfType1Phi/F");
	...
	if (_analysis.EqualTo("Stop")) {
		...
		minitree->Branch("mlb1truecomb",    &_mlb1truecomb,        "mlb1truecomb/F");
		minitree->Branch("mlb2truecomb",    &_mlb2truecomb,        "mlb2truecomb/F");
